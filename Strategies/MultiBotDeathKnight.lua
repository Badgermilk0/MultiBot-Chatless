MultiBot.addDeathKnight = function(pFrame, pCombat, pNormal)
	...
	tDpsFrame.addButton("FrostAoe", 0, 52, "spell_frost_frostbolt02", MultiBot.L("tips.deathknight.dps.frostAoe")).setDisable() -- TODO: variable still to be created
    .doLeft = function(pButton)
	...
	tDpsFrame.addButton("UnholyAoe", 0, 78, "spell_fire_felflamering", MultiBot.L("tips.deathknight.dps.unholyAoe")).setDisable() -- TODO: variable still to be created
    .doLeft = function(pButton)
