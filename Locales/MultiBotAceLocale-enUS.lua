...
local enUSValues = {
  ...
  ["tips.rtsc.move"] = "RTSC Move Mode\n|cffffffffArm move mode, then mark a location: from then on every AEDM cast moves your selection, with no further commands.|r\n\n|cffff0000Left-click to arm move mode|r\n|cff999999(Executed by: Raid, Party)|r\n\n|cffff0000Right-click to disarm|r\n|cff999999(Executed by: Raid, Party)|r",
  ...
  ["rtsc.selector.pending"] = "Pending selection: %s",
