...
local enUSValues = {
  ...
  ["tips.disperse.main"] = "Disperse\n|cffffffffSpread the bots out so they stop stacking on each other.\nThe button lights up with the active distance while disperse is on.|r\n\n|cffff0000Left-click to open the distance controls|r\n|cff999999(Executed by: Raid, Party)|r\n\n|cffff0000Right-click to disable disperse|r\n|cff999999(Executed by: Raid, Party)|r",
  ["tips.disperse.set"] = "Set disperse distance",
  ["tips.disperse.disable"] = "Disable disperse",
  ["tips.loot.main"] = "Loot rules\n|cffffffffPick what your bots pick up.\nThe button is lit while bot looting is enabled.|r\n\n|cffff0000Left-click to open the loot rules|r\n|cff999999(Executed by: Raid, Party)|r\n\n|cffff0000Right-click to disable bot looting|r\n|cff999999(Executed by: Raid, Party)|r",
